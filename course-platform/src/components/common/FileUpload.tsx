    ...
    <div className="space-y-4">
      ...
      >
        ...
        <p className="text-sm font-medium mb-1">
          Click to upload {accept === 'pdf' ? 'PDF' : accept === 'image' ? 'images' : accept === 'video' ? 'videos' : 'files'}
        </p>
        <p className="text-xs text-muted-foreground">
          {accept === 'pdf' && 'PDF files up to 50MB'}
          {accept === 'image' && 'JPEG, PNG, GIF up to 10MB'}
          {accept === 'video' && 'MP4, WebM up to 500MB'}
        </p>
        <input
          ref={inputRef}
          type="file"
